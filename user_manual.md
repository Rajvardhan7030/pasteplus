...
3. **System Dependencies:** PastePlus requires several system libraries for the GUI and clipboard interaction.
   ...
   *Note: Tauri 2.0 uses WebKit 4.1, which is natively supported on modern Linux distributions.*
...
3. PastePlus will:
   ...
   - Show a **"Copied!"** visual indicator on the selected item.
...
- **X11 Users:** Ensure `xclip` is installed.
